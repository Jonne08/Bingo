...
public class GuiArtikel extends javax.swing.JFrame {
    ...
    private void btnAddArtikelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddArtikelActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(guiArt, "Naam invullen.", "Naam invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtBarcode.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiArt, "Barcode invullen.", "Barcode invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtPrijs.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiArt, "Prijs invullen.", "Prijs invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtPuntenGekregen.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiArt, "Punten gekregen invullen.", "Punten gekregen invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtPuntenKopen.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiArt, "Punten kopen invullen.", "Punten kopen invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtMinimum.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiArt, "Minimum aantal voor puntne invullen.", "Minimum aantal voor punten invullen.", JOptionPane.ERROR_MESSAGE);
        }
        else
        {
