...
public class GuiFiliaalRapport extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GuiFiliaalRapport
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiFiliaalRapport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiFiliaalRapport().setVisible(true);
            }
        });
    }
