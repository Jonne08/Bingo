...
public class GuiFiliaal extends javax.swing.JFrame {
    ...
    private void btnAddFiliaalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFiliaalActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(guiF, "Filiaal naam  invullen.", "Filiaal naam invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtStraat.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Straat invullen.", "Straat invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtNummer.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Nummer invullen.", "Nummer invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtPostcode.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Postcode invullen.", "Postcode invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtStad.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Stad invullen.", "Stad invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtTelefoon.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Telefoon invullen.", "Telefoon invullen", JOptionPane.ERROR_MESSAGE);
        }
        else if(txtLogin.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Login invullen.", "Login invullen", JOptionPane.ERROR_MESSAGE);
        }                           
        else if(txtWachtwoord.getText().equals(""))
        {
            JOptionPane.showMessageDialog(guiF, "Wachtwoord invullen.", "Wachtwoord invullen", JOptionPane.ERROR_MESSAGE);
        }
        else
        {
