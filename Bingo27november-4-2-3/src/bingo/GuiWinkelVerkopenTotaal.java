 ...
 * @author gmavdamm
 */
public class GuiWinkelVerkopenTotaal extends javax.swing.JFrame {

    private static final GuiWinkelVerkopenTotaal guiWVT = new GuiWinkelVerkopenTotaal();
    private DefaultTableModel model;
    private Winkel wi;    
    NumberFormat num = NumberFormat.getCurrencyInstance();
    
    public static GuiWinkelVerkopenTotaal getInstance()
    {
        return guiWVT;
    }
    ...
    public GuiWinkelVerkopenTotaal() 
    {
        initComponents();
    }
    ...
    private void btnExporterenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExporterenActionPerformed
        MySQL sql = new MySQL();
        ArrayList<Verkopen> verkopen = sql.getVerkopenWinkelTotaal(wi.getWinkelID());
        ...
        String file = wi.getNaam() + " VerkopenTotaal.txt";
        ...
        JOptionPane.showMessageDialog(guiWVT, "Rapport geëxporteerd.", "Rapport geëxporteerd.", JOptionPane.INFORMATION_MESSAGE);      
   ...
   public void updateTable()
    {
        ...
        model.addRow(new Object[]{"", "", "", "", sql.getVerkopenWinkelTotaalPG(wi.getWinkelID()), num.format(sql.getVerkopenWinkelTotaalPr(wi.getWinkelID()))});
    }
